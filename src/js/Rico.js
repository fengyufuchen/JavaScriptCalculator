...
if (Object.prototype.extend) {//如果Object的原型的属性extend存在
   Rico.ArrayExtensions[ Rico.ArrayExtensions.length ] = Object.prototype.extend;//那么就扩展这个ArrayExtensions的属性域

}else{
  Object.prototype.extend = function(object) {
    //每个函数都包含两个非继承而来的方法，apply和call，这两个方法的用户都是在特定的作用域中调用函数，实际上等于设置函数体内this对象的只
    //首先apply方法接收两个参数，一个是在其中运行的函数的作用域，另一个是参数数组
...
Rico.Corner = {
   ...
   _setOptions: function(options) {
      ...
      Object.extend(this.options, options || {});//这个是什么意思？？
